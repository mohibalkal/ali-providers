...
function makeHindiScrapeEmbed(provider: { id: string; rank: number }) {
  return makeEmbed({
    id: provider.id,
...
const hindiScrapeEmbeds = hindiScrapeProviders.map(makeHindiScrapeEmbed);
